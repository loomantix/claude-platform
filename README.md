...
| `/review-accessibility` | Automated accessibility audit against a running web app — axe-core scans every route (auto-discovered or a specific list), fixes the violations it reports in source, and opens a PR. Human-triggered, needs a browser tool family, not part of the pre/post-push chain.                                                                                                                                                        |
